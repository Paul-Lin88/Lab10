...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap map) {
        ...
        polylineOption.add(new LatLng(25.033611,121.565000));
        polylineOption.add(new LatLng(25.032728,121.565137));
        polylineOption.add(new LatLng(25.047924,121.517081));
        polylineOption.color(Color.BLUE);
        Polyline polyline= map.addPolyline(polylineOption);
